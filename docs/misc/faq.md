...
How to identify large CNV calls (>10SNPs, >100kb)?
...
How to remove CNV calls in immunoglobulin regions?
...
How to remove CNV calls in centromeric and telomeric regions?
...
Does chromosome X requires special handling?
...
How to call CNVs if I have signal data for 50 SNPs in a candidate region?
...
How to identify a subset of the most confident de novo CNV calls?
...
Can PennCNV give allele-specific CNV calls?
...
How to interpret "state" in "state2,cn=1" in PennCNV output?
...
How to detect CNVs in Bovine genome?
...
Why I get "PennCNV compilation error: Can't locate loadable object" in Windows?
...
Is there other similar software for CNV calling?
...
How to call CNVs from tumor samples?
...
What published study used PennCNV?

Some citations can be found here.

 

What databases are available for checking CNVs?
...
What tools can annotate CNV calls?
